...
test.describe('CTA Buttons and Interactions', () => {
  ...
  test('should render hero CTA button with correct text', async ({ page }) => {
    const heroButton = page.getByRole('link', {
      name: /Download Your Free Theme/i,
    });
    await expect(heroButton).toBeVisible();
    await expect(heroButton).toBeEnabled();
  });

  test('hero CTA button should have correct href attribute', async ({
    page,
  }) => {
    const heroButton = page.getByRole('link', {
      name: /Download Your Free Theme/i,
  ...
  test('hero CTA button should be clickable and styled correctly', async ({
    page,
  }) => {
    const heroButton = page.getByRole('link', {
      name: /Download Your Free Theme/i,
