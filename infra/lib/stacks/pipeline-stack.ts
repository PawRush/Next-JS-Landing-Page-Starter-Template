...
export class PipelineStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    this.pipeline = new pipelines.CodePipeline(this, 'Pipeline', {
      pipelineName: 'NextJSLandingPipeline',
      selfMutation: true,
      synth,
    ...
    // Deploy frontend stack to production
    const deployStage = new cdk.Stage(this, 'Deploy', {
      env: { account: this.account, region: this.region },
    });

    new FrontendStack(deployStage, 'NextJSLandingFrontend-prod', {
      stackName: 'NextJSLandingFrontend-prod',
      environment: 'prod',
      buildOutputPath: '../out',
    });
    ...
    new cdk.CfnOutput(this, 'PipelineName', {
      value: 'NextJSLandingPipeline',
      description: 'CodePipeline Name',
      exportName: `${id}-PipelineName`,
    });

    new cdk.CfnOutput(this, 'PipelineURL', {
      value: `https://${this.region}.console.aws.amazon.com/codesuite/codepipeline/pipelines/NextJSLandingPipeline/view`,
      description: 'CodePipeline URL',
      exportName: `${id}-PipelineURL`,
    });
  }
}
